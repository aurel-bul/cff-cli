...
cff trip Romont Fribourg -n 1

# Afficher les prochains trajets pour aller de Fribourg à Bern le 03.11.2025 à 13h30
...
func init() {
	...
	trip.Flags().BoolP("carte", "c", false, "afficher la carte du trajet (défaut=false)")
}
